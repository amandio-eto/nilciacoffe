...
<div class="row">
    ...
    <div class="col-md-8 p-4">
        <div class="row" id="product-list">
            ...
            <div class="col-md-4 mb-4 product-item" data-name="{{ strtolower($p->name) }}">
                <div class="card shadow-sm rounded-4 h-100">
                    @if($p->image)
                        <img src="{{ asset('uploads/products/'.$p->image) }}" class="card-img-top rounded-top-4" style="height:160px; object-fit:cover;">
                    @else
                        <img src="https://via.placeholder.com/300x160" class="card-img-top rounded-top-4">
                    @endif
    ...
    {{-- CART --}}
    <div class="col-md-4 bg-light p-4" style="min-height:90vh;">
        <div class="card shadow rounded-4">
            <div class="card-body">
                ...
                {{-- Direct order: no tax, no discount --}}
...
function renderCart(){
    ...
    let grandTotal = total; // no tax, no discount
...
document.getElementById('paid_amount').addEventListener('input', function(){
    let grand = parseFloat(document.getElementById('total_display').innerHTML.replace('$ ','') || 0);
